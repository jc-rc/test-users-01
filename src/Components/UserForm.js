  ...
  return (
    <div className="row">
        <form action="" id='userForm' onSubmit={handleSubmit} onReset={handleReset}>
            <p className="h3">Create New User:</p>
            <hr />
            <div className="mb-3">
            ...
            <div className="mb-3">
                ...
                <input type="tel" name="" id="" className='form-control' required onChange={handleTelChange} maxLength={10} pattern="[0-9]{10}" title='Teléfono MX a 10 dígitos'/>
            </div>
            <div className="mb-3">
